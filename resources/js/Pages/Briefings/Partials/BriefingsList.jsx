...
export default function BriefingsList({ briefings, filtered, searchQuery, setSearchQuery, user }) {
            ...
            {filtered.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center px-6">
                    ...
                    <p className="font-bold text-zinc-700 dark:text-zinc-300 text-sm">
                        {searchQuery ? 'Briefing tidak ditemukan' : 'Belum ada briefing terdaftar'}
                    </p>
                        ...
                        >
                            <div className="flex items-start gap-4 min-w-0">
                                <div className={`mt-1 flex-shrink-0 h-2.5 w-2.5 rounded-full ${
                                    briefing.absensi_dibuka ? 'bg-emerald-500' : 'bg-zinc-300 dark:bg-zinc-700'
                                }`} />
