...
import CreateBriefingForm from './Partials/CreateBriefingForm';
import BriefingsList from './Partials/BriefingsList';

export default function BriefingsIndex({ briefings }) {
