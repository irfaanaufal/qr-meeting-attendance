        ...
        <div className="print-wrapper">
            ...
            <div className="print-content">
                ...
                <table className="meta-table">
                    <tbody>
                        <tr>
                            <td className="meta-label">JUDUL RAPAT</td>
                            <td className="meta-sep">:</td>
                            <td className="meta-value">{meeting.judul_rapat}</td>
                        </tr>
                        <tr>
                            <td className="meta-label">PEMATERI</td>
                            <td className="meta-sep">:</td>
                            <td className="meta-value">{meeting.user?.name || '-'}</td>
                        </tr>
                        <tr>
                            <td className="meta-label">HARI / TANGGAL</td>
                            <td className="meta-sep">:</td>
                            <td className="meta-value">{formatDateIndonesian(meeting.tanggal_jam)}</td>
                        </tr>
                        <tr>
                            <td className="meta-label">WAKTU</td>
                            <td className="meta-sep">:</td>
                            <td className="meta-value">{formatTime(meeting.tanggal_jam)} WIB</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div className="signature-section avoid-break">
                    <div className="signature-block">
                        ...
                        <p className="signature-date">{formatDateTimeFull(meeting.tanggal_jam)}</p>
                        <p className="signature-role">Pemateri</p>
                        <div className="signature-space">
                            {meeting.user?.karyawan?.signature ? (
                                <img
                                    src={`${baseUrl}/storage/${meeting.user.karyawan.signature.signature_path}`}
                        ...
                        <div className="signature-name-wrapper">
                            <p className="signature-name">({meeting.user?.name || '-'})</p>
                        </div>
                    </div>
                </div>
